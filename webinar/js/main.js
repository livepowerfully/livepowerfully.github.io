...
//        $('#signup-frm-submit').click(function (event) {
//            fn_save_subscriber();
//            event.preventDefault();
//        });
//    });
//
//    function fn_save_subscriber() {
//       
//        var data = $('#cta-signup-form').serialize();
//        //alert( data );
//        $.ajax({
//            type: "POST",
//            data: data,
...
//    }
    ...
    $("#share").jsSocials({
        showCount: false,
        shares: ["email", "facebook"], // add/remove social network
        url: "http://", // http://url.to.share
        text: "Live Powerfully" // text to share
    });
