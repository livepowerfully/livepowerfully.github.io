	...
	if ( enable_switcher ) {
		...
		var $switcher = $('<div id="style-switcher"> \
								...
								<ul id="sw-color-schemes" class="thumbs clearfix"> \
									<li><a href="#" title="Sky Blue + Orange + Red" class="clearfix"> \
									...
									<li><a href="#" title="Blue Grey + Orange + Red" class="clearfix"> \
										<div data-sm="color1-sm" class="color1-blue-grey"></div> \
										<div data-sm="color2-sm" class="color2-orange"></div> \
										<div data-sm="color3-sm" class="color3-red"></div> \
									</a></li> \
									...
									<li><a href="#" title="Green + Orange + Red" class="clearfix"> \
								...
								<ul id="sw-color1" class="thumbs clearfix"> \
									...
									<li><a href="#" title="Primary Color: Blue Grey"> \
										<div data-sm="color1-sm" class="color1-blue-grey"></div> \
									</a></li> \
									<li><a href="#" title="Primary Color: Blue"> \
										<div data-sm="color1-sm" class="color1-blue"></div> \
									</a></li> \
									<li><a href="#" title="Primary Color: Green"> \
										<div data-sm="color1-sm" class="color1-green"></div> \
									</a></li> \
								</ul> \
		...
		$switcher.find( '#reset' ).on( 'click', function(e) {
			$( '#primary-color' ).attr( 'href', 'css/primary-color/sky-blue.css' );
			$( '#secondary-color' ).attr( 'href', 'css/secondary-color/orange.css' );
			$( '#extra-color' ).attr( 'href', 'css/extra-color/red.css' );
			
			$switcher.find( '#sw-color1 li a' ).removeClass( 'active' ).find( '.color1-sky-blue' ).parent().addClass( 'active' );
