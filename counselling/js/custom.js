/*
	...
	18) Google Maps
	19) Blog Post Comments
	20) Contact Form / Comment Form / Subscription Form
*/

var enable_sticky_menu = true, // enable/disable sticky menu mode
	...
	(function() {
		...
		gmapData["mapParams1"] = {
			map_1: {
				...
				infoString: '<h6 class="gm-title">TransVision Coaching</h6><p>Life coaching services in Brisbane.</p>',
				saturation: -50
			},
		};

		// Custom parameters for the map on contact-page-2.html
		gmapData["mapParams2"] = {
			map_1: {
				posType: 'address',
				address: '1316 Adelaide Street, Brisbane City, QLD, 4000',
			...
			map_2: {
				...
				infoString: '<h6 class="gm-title">TransVision Coaching</h6><p>Life coaching services in Toowoomba.</p>',
				saturation: -50
			},
			map_3: {
				posType: 'address',
				...
				infoString: '<h6 class="gm-title">TransVision Coaching</h6><p>Life coaching services in Gold Coast.</p>',
				saturation: -50
			},
		};
		...
		// Extract custom parameters from gmapParams object
			...
			$form.on( 'click', 'input[type="submit"]', function(e) {
				...
				if ( ! hasError ) {
					...
					if ( $form.attr( 'id' ) == 'comment-form' ) { // for comment form
						var postTitle = $( '.single-post #hero-image .title-wrapper h1' ).text(),
							postDate = $( '.single-post #hero-image .title-wrapper .post-date' ).text();
